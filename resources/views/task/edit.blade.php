                        ...
                        <form method="POST" action="{{ route('task.update', [$project->id, $task->id]) }}" class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="estimated_start_date" value="{{ $task->estimated_start_date }}" class="form-control datepicker" id="estimated_start_date" required>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" name="estimated_completion_date" value="{{ $task->estimated_completion_date }}"  class="form-control datepicker" id="estimated_completion_date" required>
