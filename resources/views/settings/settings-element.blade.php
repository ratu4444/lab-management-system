                        ...
                        <div class="card-header d-block">
                            <div class="form-row">
                                ...
                                <div class="col-4 text-right">
                                    <div class="selectgroup">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="elements[7][is_enabled]" value="1" class="enabled-select-6 selectgroup-input-radio" {{ !isset($elements[7]['is_enabled']) || $elements[7]['is_enabled'] ? 'checked' : '' }}>
                                            <span class="selectgroup-button" data-class="bg-success">Show</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="elements[7][is_enabled]" value="0" class="enabled-select-6 selectgroup-input-radio" {{ !isset($elements[7]['is_enabled']) || $elements[7]['is_enabled'] ? '' : 'checked' }}>
                                            <span class="selectgroup-button" data-class="bg-danger">Hide</span>
                                        </label>
                                    </div>
                                </div>
